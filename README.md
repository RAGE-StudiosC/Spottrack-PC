...
**Versión 2.0.0**  
- Nuevo reproductor independiente usando **yt-dlp** para audio directo.  
...
| Reproducción | Player oficial de YouTube | Reproductor independiente con yt-dlp |
| Audio | Limitado, depende del player | Alta calidad, sin depender del player |
| Anuncios | Presentes | Sin anuncios |
| Control | Adelantar/retroceder podía generar retrasos | Instantáneo, sin retrasos |
...
- [Spottrack-PC 2.0.0 x64.exe](https://github.com/TU_USUARIO/Spottrack-PC/releases/download/v2.0.0/Spottrack-PC-2.0.0-x64-Setup.exe)  
- [Spottrack-PC 2.0.0 ia32.exe](https://github.com/TU_USUARIO/Spottrack-PC/releases/download/v2.0.0/Spottrack-PC-2.0.0-ia32-Setup.exe)  
- [Spottrack-PC 2.0.0 x64.appx](https://github.com/TU_USUARIO/Spottrack-PC/releases/download/v2.0.0/Spottrack-PC-2.0.0-x64-Setup.appx)  
- [Spottrack-PC 2.0.0 ia32.appx](https://github.com/TU_USUARIO/Spottrack-PC/releases/download/v2.0.0/Spottrack-PC-2.0.0-ia32-Setup.appx)
...
- Discord: [RAGE Studios Discord](https://discord.gg/...)  
- GitHub: [Spottrack-PC](https://github.com/TU_USUARIO/Spottrack-PC)

---

## 🎨 Banner y logos

Coloca imágenes en `assets/` y úsalas así en el README:
